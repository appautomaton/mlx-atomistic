...
GPU in your Mac, with no CUDA, remote cluster, or cloud. The `0.0.1` package is
...
Canonical narrative and benchmark source lives in [`docs/`](docs/). The site
pages are generated by [`scripts/sync_site_docs.py`](scripts/sync_site_docs.py),
and the API pages are generated from package docstrings by
