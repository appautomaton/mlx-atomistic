...
| Rock-salt MgO primitive Mg-q10/O-q6 feasibility, 2 atoms, 40 Ha, density-reconstructed reduced 4×4×4 | Complete wall `39.892 s`; peak temporary memory `63.8 MB`; 80 SCF iterations | Numerical diagnostic only; no EOS reference claim | Rejected: maximum direct orbital residual `3.570e-6` exceeded the locked `2e-6` gate. A density-seeded continuation also reached 80 iterations at `4.599e-6`, so the blocker is not removed by warm density. The matched full oracle and seven-point EOS were correctly skipped. |
