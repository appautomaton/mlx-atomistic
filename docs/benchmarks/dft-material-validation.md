...
| Rock-salt MgO primitive Mg-q10/O-q6 feasibility, 2 atoms, 40 Ha, historical symmetry-reduced 4×4×4 | Complete wall `40.989 s`; peak temporary memory `57.2 MB`; 80 SCF iterations | Numerical diagnostic only; no EOS reference claim | Rejected: maximum orbital residual `4.329e-6` exceeded the locked `2e-6` gate, and the historical runtime did not reconstruct rotated SCF densities. The current method fix does not revalidate this old point. No full q10 EOS was run. |
