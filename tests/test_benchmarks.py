...
def test_gpcrmd_pme_profile_admission_is_fail_closed(tmp_path):
    ...
    manifest = {
        ...
        "runtime_contract": {
            ...
            "neighbor_backend": "mlx_interaction32",
            "neighbor_representation": "interaction32",
...
def test_pme_performance_stage_summary_prefers_production_force_rows():
    ...
    summary = pme_performance._stage_timings(
        [
            ...
            row("interpolate_normalized_real_grid_force_only", 0.3),
            row("forward_fft", 30.0),
            row("influence_function", 40.0),
            row("inverse_fft_potential_and_fields", 50.0),
            row("forward_real_fft_force_path", 0.4),
            row("inverse_real_fft_influence_force_path", 0.5),
